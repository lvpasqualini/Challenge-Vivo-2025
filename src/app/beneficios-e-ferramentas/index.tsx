...
import { HeartPulse , CreditCard , BookOpenCheck , CirclePercent , Github , Figma , Trello } from "lucide-react";

export default function BeneficiosFerramentas() {
  return (
    <div className="min-h-screen flex flex-col">
      <main className="min-h-[90vh] flex flex-col items-center justify-center px-4 py-8 gap-6 md:gap-8">
        ...
        <section className="w-full max-w-4xl">
            <h3 className="text-xs mb-5 md:text-xl lg:text-2xl text-[#660099] font-semilight text-center leading-tight max-w-4xl">
                Benefícios Vivo
            </h3>
            <div className="flex flex-row justify-evenly">
                <Card
                icon={<HeartPulse className="w-12 h-12 text-[#660099] mb-2" />}
                title="Plano de Saúde"
                />
                <Card
                
                icon={<CreditCard className="w-12 h-12 text-[#660099] mb-2" />}
                title="Cartões Vr / Va"
                />
                <Card
                icon={<BookOpenCheck className="w-12 h-12 text-[#660099] mb-2" />}
                title="Auxílio educação"
                />
                
                <Card
                icon={<CirclePercent className="w-12 h-12 text-[#660099] mb-2" />}
                title="Descontos Vivo"
                />
            </div>
            <div className="flex justify-center mt-4">
                <a className="underline mb-5 text-[#660099] font-semilight text-center leading-tight max-w-4xl" href="">+ver mais</a>
            </div>
        </section>
